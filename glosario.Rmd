...
Método estadístico que permite evaluar la consistencia interna de un instrumento, es decir, qué tanto los reactivos del instrumento se relacionan entre sí, y qué tan homogéneos son. Su coeficiente se ubica en un rango de 0 a 1, siendo los valores más cercanos a 1 indicadores de una consistencia interna alta.
...
Componente que determina lo que se espera que logren los sustentantes en un área y subárea de conocimiento específica; debe definirse especificando una acción concreta, por lo que es necesario que se estructuren por medio de los niveles de aprendizaje, por ejemplo, la taxonomía de Bloom. 
...
Medida estadística que señala qué tanto los reactivos del instrumento se relacionan entre sí, y qué tan homogéneos son.
...
Técnica cualitativa que permite retroalimentar el funcionamiento de los reactivos mediante la realización de cuestionamientos a los sustentantes con el fin de identificar cómo responden al reactivo y porqué. 
...
Proceso mediante el cual se constata y vigila a través del tiempo que los usos e interpretaciones del instrumento sigan siendo válidos para futuras aplicaciones.

##	Marco conceptual: {-#marco-conceptual}
Base teórica sobre la que se construye la definición del constructo, la operacionalización de este y la construcción de la tabla de especificaciones. Se refiere a la teoría o evidencia bibliográfica sobre la que se sustenta el examen.

##	Modelo de 1 parámetro: {-#R1PL}
Modelo explicativo que parte de la Teoría de Respuesta al Ítem, utiliza únicamente el nivel de habilidad y el índice de dificultad del reactivo como criterios para calcular la probabilidad de que un participante responda correctamente.

##	Modelo de 2 parámetros: {-#R2PL}
Modelo explicativo que parte de la Teoría de Respuesta al Ítem, utiliza  el nivel de habilidad, el índice de dificultad y el nivel de discriminación del reactivo como criterios para calcular la probabilidad de que un participante responda correctamente.
...
Estadístico que permite medir la confiabilidad de consistencia interna. Difiere del Alfa de Cronbach, en que permite tomar en consideración la dimensionalidad factorial del examen para obtener los coeficientes de confiabilidad por cada uno de los factores que lo conforman. Suele ser una alternativa más estable y menos sesgada para obtener la confiabilidad del examen.
...
Serie de indicadores cuantitativos que dan cuenta de las propiedades del instrumento en términos estadísticos. Entre los más utilizados se encuentran la confiabilidad, la dimensionalidad y las propiedades de los reactivos.
...
Reactivos utilizados en pruebas paralelas que se conservan iguales en ambas versiones del examen, tanto a nivel de contenido como de posición en el examen, permitiendo con ello equipararlos al momento de obtener la calificación final de los alumnos.  
...
##	Sesgo: {-#sesgo}
Situación/característica/cualidad que imposibilita la validez en los usos e interpretaciones del examen para todas las poblaciones. Los sesgos influyen en las poblaciones beneficiando a unas sobre otras, respecto a las características del examen, proceso de construcción, aplicación e interpretación del mismo. Evitar la presencia de sesgos garantiza la imparcialidad en el proceso de desarrollo del examen.

##	Subrepresentación del constructo: {-#subrep}
Este fenómeno puede ocurrir cuando la cantidad de reactivos que tenemos en nuestro examen no da cuenta de forma representativa del objeto que pretendemos medir, dejando aspectos fundamentales del mismo sin ser evaluados. Esto puede ocurrir porque desde un principio la definición no fue lo suficientemente extensa, por no generar los suficientes reactivos, o porque tras el análisis psicométrico de estos, se eliminaron reactivos que evalúan aspectos muy importantes sin tener ningún otro que diera cuenta de ese aspecto.

##	Tabla de especificaciones: {-#tabla-espec-G}
Herramienta que permite generar un registro de la estructura del examen, desde la definición del constructo que se busca medir, pasando por sus dimensiones, subdimensiones y cantidad de reactivos necesarios para evaluar cada uno, así como los niveles de aprendizaje buscados. Sirve como una guía fundamental para el proceso de redacción de los reactivos.

##	Teoría Clásica de los Tests:{-#TCT-G}
Teoría de medición en psicología y educación basada en el principio de que el puntaje verdadero de una persona es la suma de su puntaje en un examen y del error de medición, por tanto, se centra relevantemente en medir y tratar de controlar estos niveles de error, para con ello generar puntuaciones más cercanas al puntaje verdadero de la persona en el constructo medido.
