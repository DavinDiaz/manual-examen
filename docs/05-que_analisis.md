...
Para poder determinar la estructura interna de un instrumento, son dos las principales técnicas utilizadas: análisis factorial exploratorio (AFE) y análisis factorial confirmatorio (AFC).
